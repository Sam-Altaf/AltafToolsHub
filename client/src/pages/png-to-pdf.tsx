...
import { 
  ...
  FileImage, Settings, Sparkles, Zap, Shield, Layers, FileText, Book
} from "lucide-react";
...
export default function PngToPDF() {
  ...
  const howToSchema = generateHowToSchema({
    ...
    description: "Convert multiple PNG images to a single PDF document with transparency support",
    totalTime: "PT1M",
    steps: [
      { name: "Select Images", text: "Upload one or more PNG images" },
  ...
  const softwareSchema = generateSoftwareApplicationSchema({
    name: "PNG to PDF Converter - AltafToolsHub",
    description: "Free PNG to PDF converter with transparency support. Multiple layouts and custom settings. 100% browser-based, lossless quality.",
    applicationCategory: "MultimediaApplication",
    url: "https://www.altaftoolshub.app/png-to-pdf",
  ...
  useSEO({
    title: "Convert PNG to PDF Online Free - Preserve Transparency Quality",
    description: "Free PNG to PDF converter online with transparency support. Convert multiple PNG images to PDF with lossless quality preservation. 100% secure browser-based processing - your images never leave your device. Perfect for screenshots, graphics, and transparent images.",
    path: "/png-to-pdf",
    keywords: "png to pdf converter, convert png to pdf online, png to pdf with transparency, image to pdf converter, transparent png to pdf, batch png to pdf, multiple png to pdf, png pictures to pdf converter 2025, lossless png to pdf conversion",
    ogImage: "https://altaftoolshub.app/og-png-to-pdf.png",
    structuredData: [howToSchema, softwareSchema],
    additionalMetaTags: [
      { name: "application-name", content: "PNG to PDF Converter - AltafToolsHub" },
      { property: "article:section", content: "Image Tools" },
      { property: "article:tag", content: "PNG Conversion" },
      { property: "article:tag", content: "PDF Creation" },
      { property: "article:tag", content: "Transparency Support" },
      ...
      for (let i = 0; i < selectedFiles.length; i++) {
        ...
        try {
          ...
          const pngBlob = await new Promise<Blob>((resolve, reject) => {
            ...
            }, 'image/png', getQualityValue(quality));
          });
      ...
      <div className="min-h-screen pattern-bg">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-primary">PNG to PDF Converter</h1>
    ...
    return (
      <div className="min-h-screen pattern-bg">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-primary">PNG to PDF Converter</h1>
            <p className="text-lg text-muted-foreground">Converting your PNG images to PDF...</p>
          </div>
  ...
  return (
    <div className="min-h-screen pattern-bg">
      <ToolSEO 
        ...
        description="Convert multiple PNG images to PDF with transparency preservation and customizable layouts"
        category="UtilitiesApplication"
        faqs={toolFAQs["png-to-pdf"]}
        rating={{ value: 4.8, count: 456 }}
      />
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Convert PNG images to PDF with transparency preservation and lossless quality. 
            Perfect for screenshots, graphics, and transparent images.
          </p>
        </div>
        ...
        steps={[
          {
            ...
            description: "Select or drag multiple PNG images. Transparency will be preserved automatically.",
            icon: Upload
          },
          {
            number: 2,
          ...
          <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <Link href="/guides/how-to-convert-png-to-pdf" className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 underline transition-colors">
                  Read our complete guide: How to Convert PNG to PDF
                </Link>
              </div>
            </div>
          </div>
      ...
      <WhyUseSection
        toolName="PNG to PDF Converter"
        benefits={[
          "Convert unlimited PNG images to PDF without any restrictions",
          "Full transparency support with lossless quality preservation",
      ...
      <ComparisonSection
        ...
        comparisons={[
          ...
          { feature: "Transparency Support", ourTool: "Full PNG alpha channel", others: "Lost during conversion" },
