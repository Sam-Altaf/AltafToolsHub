...
export default function CombinePDF() {
  ...
  const [combinedPdf, setCombinedPdf] = useState<Uint8Array | null>(null);
  const [draggedIndex, setDraggedIndex] = useState<number | null>(null);
  const { toast } = useToast();

  // Generate structured data for SEO
  const howToSchema = generateHowToSchema({
    name: "How to Combine PDF Files into One Document",
    description: "Join multiple PDF files together into a unified document with our free online tool",
    totalTime: "PT2M",
    steps: [
      { name: "Select Files", text: "Upload or drag and drop PDF files you want to combine" },
      { name: "Order Files", text: "Arrange PDFs in your preferred sequence by dragging" },
      { name: "Combine PDFs", text: "Click 'Combine PDFs' to unite all files into one" },
      { name: "Save Combined PDF", text: "Download your newly combined PDF document" }
    ]
  });

  const softwareSchema = generateSoftwareApplicationSchema({
    name: "PDF Combiner - AltafToolsHub",
    description: "Effortlessly combine multiple PDF documents into one file. Free online tool with drag-and-drop ordering and 100% privacy protection.",
    applicationCategory: "BusinessApplication",
    url: "https://www.altaftoolshub.app/combine-pdf",
    aggregateRating: { ratingValue: 4.9, ratingCount: 3842, bestRating: 5 },
    featureList: [
      "Combine unlimited PDF documents",
      "Intuitive drag-and-drop reordering",
      "Complete browser-based processing",
      "Zero file uploads to servers",
      "Maintains original quality",
      "Compatible with all PDF standards"
    ],
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: "Combine PDF", url: "/combine-pdf" }
  ]);

  useSEO({
    title: "Combine PDF Files Online Free - Join Multiple PDFs into One | AltafToolsHub",
    description: "Free PDF combiner to join multiple PDF documents into a single file. Drag-and-drop interface, no file uploads, 100% secure browser-based processing. Combine PDFs instantly with no limits or registration.",
    path: "/combine-pdf",
    keywords: "combine pdf, join pdf, pdf combiner, combine pdf files, join pdf files online, unite pdf documents, pdf joiner, combine multiple pdfs",
    ogImage: "https://www.altaftoolshub.app/og-combine-pdf.png",
    structuredData: [howToSchema, softwareSchema, breadcrumbSchema],
    additionalMetaTags: [
      { name: "application-name", content: "PDF Combiner - AltafToolsHub" },
  ...
  const combinePDFs = async () => {
    ...
    if (pdfFiles.length < 2) {
      toast({
        ...
        description: "Please add at least 2 PDF files to combine",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      setCombinedPdf(combinedPdfBytes);
      ...
      toast({
        title: "Success!",
        description: "PDFs combined successfully",
      });
    } catch (error) {
      toast({
        title: "Error",
        description: "Failed to combine PDFs. Please try again.",
        variant: "destructive"
      });
    } finally {
    ...
    <div className="min-h-screen pattern-bg">
      <div className="container mx-auto px-4 py-6">
        ...
        <nav className="flex text-sm text-muted-foreground mb-6" aria-label="Breadcrumb">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Combine PDF</span>
        </nav>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-6">
              Join multiple PDF documents into one unified file in seconds. 
              100% free, no registration needed, completely private with browser-based processing.
            </p>
          ...
          <Alert className="mb-8 border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-900/20">
            ...
            <AlertDescription className="text-green-800 dark:text-green-200">
              <strong>100% Privacy Guaranteed:</strong> Your PDFs are combined entirely in your browser. 
          ...
          <Card className="p-10 mb-12 shadow-xl">
            {!combinedPdf ? (
                    ...
                    <div className="mb-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold">
                          {pdfFiles.length} PDF{pdfFiles.length !== 1 ? 's' : ''} ready to combine
                        </h3>
                      ...
                      >
                        {isProcessing ? (
                          <>
                            ...
                            Combining {pdfFiles.length} PDFs...
                          </>
                        ) : (
                          <>
                            <FilePlus className="w-5 h-5 mr-2" />
                            Combine {pdfFiles.length} PDFs into One
                          </>
                        )}
                      </Button>
                      <Button
              ...
              <div className="text-center py-8">
                ...
                <h2 className="text-3xl font-bold mb-3">PDFs Combined Successfully!</h2>
                <p className="text-lg text-muted-foreground mb-8">
                  Your {pdfFiles.length} PDF files have been united into a single document
                </p>
                <div className="flex gap-4 justify-center">
                  <Button onClick={downloadCombinedPdf} size="lg" className="h-12 px-8" data-testid="button-download">
                    <Download className="w-5 h-5 mr-2" />
                    Download Combined PDF
                  </Button>
                  <Button onClick={reset} variant="outline" size="lg" className="h-12 px-8" data-testid="button-combine-more">
                    Combine More PDFs
                  </Button>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Combine PDFs instantly with no upload wait time or server processing delays.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Combine unlimited PDFs with no file size restrictions or daily quotas.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Start combining immediately without creating an account or signing in.</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          {/* How It Works */}
          <Card className="p-8 mb-8">
            <h2 className="text-3xl font-bold mb-6">How to Combine PDF Files</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <h3 className="font-semibold text-center mb-2">Select PDFs</h3>
                <p className="text-sm text-muted-foreground text-center">
                  Upload or drag multiple PDF files to combine together
                </p>
              </div>
              <div>
                <div className="relative">
                ...
                <h3 className="font-semibold text-center mb-2">Arrange Sequence</h3>
                <p className="text-sm text-muted-foreground text-center">
                  Drag files to order them in your preferred sequence
                </p>
              </div>
              <div>
                <div className="relative">
                ...
                <h3 className="font-semibold text-center mb-2">Click Combine</h3>
                <p className="text-sm text-muted-foreground text-center">
                  Click the combine button to unite all PDFs instantly
                </p>
              </div>
              <div>
                <div className="relative">
                ...
                <h3 className="font-semibold text-center mb-2">Download Combined</h3>
                <p className="text-sm text-muted-foreground text-center">
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <Link href="/guides/how-to-combine-pdf-files" className="text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 underline transition-colors">
                    Read our complete guide: How to Combine PDF Files
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Unite lecture notes, assignments, and study materials into one PDF for easy access.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Join contracts, proposals, and reports into unified business packages.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Join chapters and sections to create complete digital books or magazines.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Combine legal documents, evidence, and exhibits for court submissions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6">
              <div className="pb-4 border-b">
                <h3 className="font-semibold mb-2 text-lg">How many PDF files can I combine at once?</h3>
                <p className="text-muted-foreground">
                  You can combine unlimited PDF documents at once. There's no restriction on file count. 
                  The only limitation is your device's available memory and processing power. 
                  We've successfully tested combining over 100 PDFs in a single operation.
                </p>
              </div>
              <div className="pb-4 border-b">
                <h3 className="font-semibold mb-2 text-lg">Are there file size limits when combining PDFs?</h3>
                <p className="text-muted-foreground">
                  No, there are no fixed file size limits. Since all processing happens in your browser, 
                  you can combine PDFs of any size. Large files (100MB+) work perfectly fine. 
                  The processing speed depends on your device's performance.
                </p>
              </div>
              <div className="pb-4 border-b">
                <h3 className="font-semibold mb-2 text-lg">Does combining PDFs reduce quality?</h3>
                <p className="text-muted-foreground">
                  Absolutely not. Our combiner preserves the exact quality of your original PDFs. 
