...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Advertising Disclosure**: We may display advertisements to support free tools and cover server/maintenance costs. Tools remain free to use. We display ads to maintain this free service. If we implement advertising: we will update this privacy policy 30 days in advance, advertising will be clearly marked and distinguishable from content, we will not use behavioral targeting or retargeting, and we will not share your data with advertising networks.",
      "**Service Sustainability**: While our tools remain free to use, if server costs become unsustainable due to growth (e.g., 100,000+ daily users), we may introduce optional premium tiers while keeping basic features free. Any such changes will be announced 30 days in advance.",
