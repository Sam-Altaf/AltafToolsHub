...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Future Advertising Disclosure**: While we currently do not use any advertising services, we may introduce non-intrusive advertising in the future to support our free services. If we do: we will update this privacy policy 30 days in advance, advertising will be clearly marked and distinguishable from content, we will not use behavioral targeting or retargeting, we will not share your data with advertising networks, and you will always have the option to use an ad-free version.",
      "**What We DON'T Use Currently**: No Facebook Pixel or social media tracking. No advertising networks or ad tracking. No session recording tools. No heat mapping beyond basic analytics. No A/B testing tools that track individuals. No customer data platforms or CRMs. No cross-site tracking or fingerprinting.",
