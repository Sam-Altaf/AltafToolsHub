...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "**Service Sustainability & Monetization**: Our tools are currently free to use, however we reserve the right to introduce premium features, paid tiers, subscription models, usage limitations, or any other monetization methods at any time without prior notice. Changes may be necessary due to operational costs, growth patterns, sustainability needs, or business requirements. The 'Free Forever' designation refers to our current model and is subject to change without notice.",
      "**Affiliate Marketing & Sponsored Content**: We may participate in affiliate marketing programs and display sponsored content without prior notice. This includes earning commissions from qualifying purchases through affiliate links, featuring sponsored tool recommendations, displaying partner service promotions, and implementing commission-based referral systems. Your file data is never shared with affiliate partners.",
